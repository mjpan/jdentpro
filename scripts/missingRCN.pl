...
#tabulate the number of missing rcns
...
my %mysqlParamsHash1 =();
$mysqlParamsHash1{"dbhost"} = "localhost";
$mysqlParamsHash1{"dbname"} = "dental";
$mysqlParamsHash1{"dbuser"} = "apache";
$mysqlParamsHash1{"dbpwd"} = "apache";
$mysqlParamsHash1{"dbport"} = 5432;
$mysqlParamsHash1{"dbms"} = "mysql";

#backup#1 database from which to recover data
my %mysqlParamsHash2 =();
$mysqlParamsHash2{"dbhost"} = "localhost";
$mysqlParamsHash2{"dbname"} = "dental_20060423";
$mysqlParamsHash2{"dbuser"} = "apache";
$mysqlParamsHash2{"dbpwd"} = "apache";
$mysqlParamsHash2{"dbport"} = 5432;
$mysqlParamsHash2{"dbms"} = "mysql";

#backup#2 database from which to recover data
my %mysqlParamsHash3 =();
$mysqlParamsHash3{"dbhost"} = "localhost";
$mysqlParamsHash3{"dbname"} = "dental_20060423";
$mysqlParamsHash3{"dbuser"} = "apache";
$mysqlParamsHash3{"dbpwd"} = "apache";
$mysqlParamsHash3{"dbport"} = 5432;
$mysqlParamsHash3{"dbms"} = "mysql";
...
sub findMissingRCN {
    ...
    my $mysqlh = mysqlHandle(\%mysqlParamsHash3);
    ...
    my $missing = 0;
#    for my $rcn (1000..5412) {
    for my $rcn (1000..5242) {
	unless ($patnumByRCN{$rcn}) {
	    print $rcn, "\n";
	    $missing ++;
	}
    }
    print "missing total of $missing records\n";
}
